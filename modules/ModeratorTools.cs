...
public class ModeratorTools : BattleBitModule {
    ...
    [CommandCallback("Say", Description = "Prints a message to all players", AllowedRoles = Roles.Moderator | Roles.Admin)]
    public void Say(RunnerPlayer commandSource, string message) {
        this.Server.SayToAllChat(message);
    }

    [CommandCallback("SayToPlayer", Description = "Prints a message to all players", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("AnnounceShort", Description = "Prints a short announce to all players", AllowedRoles = Roles.Moderator | Roles.Admin)]
    public void AnnounceShort(RunnerPlayer commandSource, string message) {
        this.Server.AnnounceShort(message);
    }

    [CommandCallback("AnnounceLong", Description = "Prints a long announce to all players", AllowedRoles = Roles.Moderator | Roles.Admin)]
    public void AnnounceLong(RunnerPlayer commandSource, string message) {
        this.Server.AnnounceLong(message);
    }

    [CommandCallback("Message", Description = "Messages a specific player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Clear", Description = "Clears the chat", AllowedRoles = Roles.Moderator | Roles.Admin)]
    public void Clear(RunnerPlayer commandSource) {
        this.Server.SayToAllChat("".PadLeft(30, '\n') + "<size=0%>Chat cleared");
    }

    [CommandCallback("Kick", Description = "Kicks a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Ban", Description = "Bans a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Kill", Description = "Kills a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Gag", Description = "Gags a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Ungag", Description = "Ungags a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Mute", Description = "Mutes a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Unmute", Description = "Unmutes a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Silence", Description = "Mutes and gags a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Unsilence", Description = "Unmutes and ungags a player", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("LockSpawn", Description = "Prevents a player or all players from spawning", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("UnlockSpawn", Description = "Allows a player or all players to spawn", AllowedRoles = Roles.Moderator | Roles.Admin)]
    ...
    [CommandCallback("Inspect", Description = "Inspects a player or stops inspection", AllowedRoles = Roles.Moderator | Roles.Admin)]
