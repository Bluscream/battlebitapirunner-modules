...
public class PermissionsCommands : BattleBitModule
{
    ...
    [CommandCallback("addidperm", Description = "Adds a permission to a player", AllowedRoles = Roles.Admin)]
    ...
    [CommandCallback("removeidperm", Description = "Removes a permission from a player", AllowedRoles = Roles.Admin)]
